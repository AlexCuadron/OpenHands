"""This file contains the tool calling implementation for different actions.
...
from openhands.core.exceptions import (
    ToolCallNotExistsError as ToolCallNotExistsError,
    ToolCallValidationError as ToolCallValidationError,
)
    ...
    if hasattr(assistant_msg, 'tool_calls') and assistant_msg.tool_calls:
        ...
        for i, tool_call in enumerate(assistant_msg.tool_calls):
            ...
            action.tool_call_metadata = ToolCallMetadata(
                ...
                function_name=tool_call.function.name,  # Keep as function_name for compatibility
